...
HOW TO BUILD
<del>Have the lwjgl jar files in the lib/ folder, and any needed native libraries (.dll, .so, etc.) in native/.
...
Or weapons you pick up with time, like a lightsaber in the future level(s)?</del>
